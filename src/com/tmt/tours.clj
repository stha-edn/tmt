...
(defn- day-tours-section []
  [:section {:class "bg-gray-50"}
   [:div {:class "max-w-6xl mx-auto px-8 py-16 md:py-24"}
    (shared/section-heading "Day Tours" "Popular Excursions")
...
(defn- half-day-section []
  [:section {:class "bg-white"}
   [:div {:class "max-w-6xl mx-auto px-8 py-16 md:py-24 grid gap-10 md:grid-cols-2 items-center"}
    [:div
     (shared/section-heading "Half-Day Tours" "Short on Time? No Problem")
     [:p {:class "mt-4 text-pretty text-gray-600 leading-relaxed"}
...
(defn- more-ways-section []
  [:section {:class "bg-gray-50"}
   [:div {:class "max-w-6xl mx-auto px-8 py-16 md:py-24"}
    (shared/section-heading "And More" "More Ways to Travel With Us")
